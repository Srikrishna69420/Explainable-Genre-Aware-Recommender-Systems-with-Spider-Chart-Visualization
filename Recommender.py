...
This is where you can try to experiment with the code. I have made three different types of people, all of whom have different taste. 

The first one aligns closely with a child, who loves movies like Toy Story, How to Train Your Dragon, Madagascar and many more. I have included a few movies 
which a child would have watched. The top movies which were recommended was Toy Story, Shrek and Monsters Inc. 

The second one aligns closely with someone who loves thriller and horror movies like Insidious, The Conjuring and many more. The top movie which was
recommended was Silence of the Lambs, American Psycho and Copycat. 

The third one aligns closely with someone who loves action and adventure movies like Inception and many more. The top movie which was Creator: The Past, 
Aelita: The Queen of Mars and Once Upon a Time

Following this, you can change the number of movies recommended by changing the k value below. 
...
if __name__ == "__main__":
    ...
    #First
    #preferred_genres = ["Children","Comedy","Fantasy","Animation"]
    #watched_movies = [1, 33615, 62999, 76093, 142058, 546, 3157, 97225]

    #Second
    #preferred_genres = ["Crime","Horror","Mystery","Thriller"]
    #watched_movies = [159858, 203078, 115534, 223191, 85788, 104908]

    #Third
    preferred_genres = ["Action", "Adventure", "Drama", "Romance"]
    watched_movies = [270526, 274053, 1721, 79132, 2628, 5378]
